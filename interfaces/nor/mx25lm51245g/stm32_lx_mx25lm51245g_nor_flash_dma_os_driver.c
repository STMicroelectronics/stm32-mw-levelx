...
#include "stm32_lx_mx25lm51245g_nor_flash_dma_os_driver.h"
...
UINT stm32_lx_mx25lm51245g_nor_flash_dma_os_driver_initialize(LX_NOR_FLASH *nor_flash)
{
  UINT ret = LX_SUCCESS;
  ...
  mx25lm51245g_register_read_cplt_callback(p_mx25lm51245g_obj, mx25lm51245g_read_cplt_callback, (void *)&nor_ctx->data_rx_cplt_semaphore);
  mx25lm51245g_register_write_cplt_callback(p_mx25lm51245g_obj, mx25lm51245g_write_cplt_callback, (void *)&nor_ctx->data_tx_cplt_semaphore);
                                           ...
                                           ULONG words)
{
  ...
  else
  {
    ...
    status = mx25lm51245g_read_dma(p_mx25lm51245g_obj, MX25LM51245G_4BYTES_SIZE, (uint8_t *) destination,
...
static UINT stm32_lx_nor_flash_driver_write(LX_NOR_FLASH *nor_flash, ULONG *flash_address, ULONG *source, ULONG words)
{
  ...
  else
  {
    ...
    status = mx25lm51245g_write_dma(p_mx25lm51245g_obj, MX25LM51245G_4BYTES_SIZE, (uint8_t *) source,
                                    (uint32_t)flash_address, words * sizeof(ULONG));
    if (status != MX25LM51245G_OK)
    {
      return LX_ERROR;
